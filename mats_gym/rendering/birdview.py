...
class BirdViewRenderer(Renderer):
    def __init__(
        ...
        self._display: pygame.Surface = pygame.display.set_mode(
            size=(self._width, self._height), flags=flags
        )
        pygame.display.set_caption("ADEX BirdView Renderer")
        font = pygame.font.Font(pygame.font.get_default_font(), 20)
        text_surface = font.render(
            "Rendering map...", True, pygame.Color((255, 255, 255))
        )
        self._display.blit(
            text_surface,
            text_surface.get_rect(center=(self._width / 2, self._height / 2)),
        )
